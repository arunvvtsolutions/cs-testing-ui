...
const TopDentalColleges = ({ topColleges }: { topColleges: ICollegeData }) => {
  return (
    <Page
...
TopDentalColleges.getLayout = function getLayout(page: ReactElement) {
...
export const getStaticProps: GetStaticProps = async ({ params }: any) => {
  const data = await getTopCollegesData(3, params.category, params.top, Stream.MEDICAL);
...
export default TopDentalColleges;
