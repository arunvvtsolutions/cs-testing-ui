...
const TopMedicalColleges = ({ topColleges }: { topColleges: ICollegeData }) => {
  return (
    <Page
...
TopMedicalColleges.getLayout = function getLayout(page: ReactElement) {
...
export const getStaticProps: GetStaticProps = async ({ params }: any) => {
  const data = await getTopCollegesData(2, params.category, params.top, Stream.MEDICAL);
